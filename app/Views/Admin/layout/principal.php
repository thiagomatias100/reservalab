...
<head>
  ...
  <!-- Esta action renderizará os estilos específicos da view que estender esse layout -->
...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- Esta action renderizará os conteúdos específicos da view que estender esse layout -->
        ...
        <!-- Esta action renderizará os RODA PÉ específicos da view que estender esse layout -->
        <?= $this->renderSection('rodape') ?>
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"> UNIVERSIDADE FEDERAL DO MARANHÃO CAMPUS SÃO BERNARDO</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Desenvolvido por <a href="https://www.bootstrapdash.com/" target="_blank">ufma.com.br</a> |Campus São Bernardo</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
  ...
  <!-- Esta action renderizará os scripts específicos da view que estender esse layout -->
